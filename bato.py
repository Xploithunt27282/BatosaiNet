...
def print_banner():
    banner = [
        "___   _ _____ ___  ___   _   ___   _  _ ___ _____   ",
        "| _ ) /_\_   _/ _ \/ __| /_\ |_ _| | \| | __|_   _| ",
        "| _ \/ _ \| || (_) \__ \/ _ \ | |  | .` | _|  | |  ",
        "|___/_/ \_\_| \___/|___/_/ \_\___| |_|\_|___| |_|  ",
        
        "BatosaiFLOOD | Attacking | Free Tool !",
        "Developer By : BaT0S41NET",
...
def main():
    os.system("title Flooding Attacking By BaT0S41NET")
    clear_screen()
    print_banner()
    ...
    print("2, TCP-FLOOD")
    print("3, WIFI-FLOOD")
    choice = input("./PHU.B4T0S41@Attack~$: ")
